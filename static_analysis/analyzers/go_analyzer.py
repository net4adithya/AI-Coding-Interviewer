...
class GoAnalyzer(BaseAnalyzer):
    """Mock Go analyzer returning deterministic metrics for testing."""
    ...
    def analyze(self, source_code: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "class_count": source_code.count('type ') and source_code.count('struct'),
            "variable_count": source_code.count(':=') + source_code.count('var '),
