...
class RustAnalyzer(BaseAnalyzer):
    """Mock Rust analyzer returning deterministic metrics for testing."""

    def supported_language(self) -> str:
        return "rust"

    def analyzer_name(self) -> str:
        return "MockRustAnalyzer"
    ...
    def analyze(self, source_code: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "function_count": source_code.count('fn '),
            "class_count": source_code.count('struct ') + source_code.count('enum '),
            "variable_count": source_code.count('let '),
