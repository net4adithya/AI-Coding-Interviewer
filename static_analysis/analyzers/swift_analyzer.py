...
class SwiftAnalyzer(BaseAnalyzer):
    """Mock Swift analyzer returning deterministic metrics for testing."""

    def supported_language(self) -> str:
        return "swift"

    def analyzer_name(self) -> str:
        return "MockSwiftAnalyzer"
    ...
    def analyze(self, source_code: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "function_count": source_code.count('func '),
            "class_count": source_code.count('class ') + source_code.count('struct '),
            "variable_count": source_code.count('let ') + source_code.count('var '),
